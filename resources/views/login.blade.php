...
<body class="mb-48">
    <nav class="flex justify-between items-center mb-4">
        <a href="http://localhost/ToDoList/public/"><img class="w-24" src="images/logo3.png" alt="" class="logo" /></a>
    </nav>
    <main>
        <div class="mx-4">
            <div class="bg-gray-50 border border-gray-200 p-10 rounded max-w-lg mx-auto mt-24">
                ...
                <form method="POST" action="http://localhost/ToDoList/public/users/authenticate">
                    @csrf
                    <div class="mb-6">
                    ...
                    <div class="mt-8">
                        <p>
                            ...
                            <a href="http://localhost/ToDoList/public/register" class="text-gray-400">Register</a>
                        </p>
                    </div>
                </form>
            </div>
